module.exports = exports = function(config, BASH_COLORS_HELPER) {
    ...
    argv_array.forEach(function(val) {
        ...
        // node server.js --homePage=/www/Video-Conferencing.html
        ...
        if (val === '--help') {
            ...
            console.log(BASH_COLORS_HELPER.getYellowFG(), '--homePage=/www/Video-Conferencing.html');
            console.log('\tOpen a specific demo instead of loading list of www.');
